	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(files, url, onLoadEnd) {
				var imageFormData, i, response, multiple, _imagePreviewUrls2, _imagePreviewUrls3, err, _err;
						...
						switch (_context.prev = _context.next) {
							...
							case 10:
								...
								if (response instanceof Array || typeof response === 'string') {
									...
									if (multiple === false) {
										_imagePreviewUrls3 = response instanceof Array ? response.url : [response.url];
									} else {
										_imagePreviewUrls3 = this.state.imagePreviewUrls.concat(response.url);
									}
									this.setState({
										imagePreviewUrls: _imagePreviewUrls3,
										optimisticPreviews: [],
										loadState: 'success'
									});
									if (onLoadEnd && typeof onLoadEnd === 'function') {
...
ImagesUploader.propTypes = {
	...
	acceptInput: _react.PropTypes.string
};
